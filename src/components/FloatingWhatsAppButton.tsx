...
export function FloatingWhatsAppButton({
  ...
  const digits = (whatsappDial ?? "").replace(/\D/g, "");
  ...
  return (
    <a
      ...
      title={label}
      className={[
        "fixed bottom-4 left-4 z-[260] inline-flex items-center gap-2 rounded-full",
        "border border-black/10 bg-[#25D366] px-4 py-3 text-white shadow-[0_18px_45px_-22px_rgba(0,0,0,0.85)]",
